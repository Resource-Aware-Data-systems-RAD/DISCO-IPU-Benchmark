...
set_target_properties(openvino::frontend::onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_onnx_frontend.so"
  IMPORTED_SONAME_RELEASE "libopenvino_onnx_frontend.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::onnx )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::onnx "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_onnx_frontend.so" )
...
set_target_properties(openvino::frontend::paddle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_paddle_frontend.so"
  IMPORTED_SONAME_RELEASE "libopenvino_paddle_frontend.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::paddle )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::paddle "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_paddle_frontend.so" )
...
set_target_properties(openvino::frontend::tensorflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_tensorflow_fe.so"
  IMPORTED_SONAME_RELEASE "libopenvino_tensorflow_fe.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::tensorflow )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::tensorflow "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_tensorflow_fe.so" )
...
set_target_properties(openvino::runtime::c PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_c.so"
  IMPORTED_SONAME_RELEASE "libopenvino_c.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime::c )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime::c "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino_c.so" )
...
set_target_properties(openvino::runtime PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino.so"
  IMPORTED_SONAME_RELEASE "libopenvino.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime "${_IMPORT_PREFIX}/runtime/lib/armv7l/libopenvino.so" )
